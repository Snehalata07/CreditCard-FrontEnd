...
class UpdateAccount extends React.Component {
    ...
    componentDidMount() {
        axios
          .get(`http://localhost:9090/accounts/getAccount/${this.props.match.params.accountNumber}`
          )
          .then((res) => {
    ...
    handleSubmit = (event) => {
        ...
        // sending request
        const dataUrl = 'http://localhost:9090/accounts/updateAccount/accountNumber';
        axios
            .put(  dataUrl , this.state.account)
            .then((response) => {
